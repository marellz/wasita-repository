    ...
    <div v-else class="space-y-10">
      <div>
        ...
        <div class="flex flex-wrap gap-4 justify-between">
          ...
          <div class="flex space-x-2">
            ...
            <base-button v-if="auth.user.id === document.user_id" variant="danger" @click="deleteDocument(document.id)">
      ...
      <div>
        ...
        <form @submit.prevent="createRemark">
          <div class="space-y-4">
            <form-text placeholder="What are your thoughts on this document?" v-model="comment" required
              :error="remarkStore.error?.comment"></form-text>
        ...
        <div class="py-5">
          <template v-if="remarks.length">
            ...
            <div class="mt-3 space-y-2">
              <div v-for="remark in remarks" :key="remark.id" class="border rounded-xl p-4">
                <div class="flex">
                  <div class="flex-auto">
                    <h1 class="text-lg">
                      {{ remark.content }}
                  ...
                  <button v-if="remark.user_id === auth.user?.id" type="button" @click="deleteComment(remark.id)">
                    <Trash2 />
                  </button>
                </div>
              </div>
