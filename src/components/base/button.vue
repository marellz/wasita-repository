<template>
  ...
  <button
    class="px-4 py-2.5 md:px-6 text-sm md:text-base font-medium rounded-lg transition-colors border inline-flex items-center space-x-2 justify-center relative"
