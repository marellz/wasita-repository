  ...
  <label class="block" :for="id">
    ...
    <div
      ...
      <div>
        ...
        <template v-else>
          <h1 class="font-medium font-funnel text-2xl text-center md:text-left">Add a document</h1>
          <p class="text-center md:text-left">Upload a document you wish to upload</p>
